...
SupportDialog {
    ...
    hook: qsTr("Thank you for using Karuselli! If you find it useful, "
    ...
    SupportAction {
        ...
        description: qsTr("Improve Karuselli in your language on Transifex.")
        link: "https://explore.transifex.com/fravaccaro/karuselli"
    }
    ...
    SupportAction {
        ...
        link: "https://github.com/fravaccaro/harbour-karuselli/issues"
    }
    ...
    DetailsDrawer {
        ...
        DetailsParagraph {
            text: qsTr("Karuselli is free software (GPLv3) for customizing the Sailfish OS "
                       + "partner space. It is maintained in spare time.")
        }

        DetailsParagraph {
            text: qsTr("Donations and contributions help keep the app compatible "
                       + "with new Sailfish releases.")
        }
    }
